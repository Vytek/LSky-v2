...
//		LSky             _target;
		...
		SerializedProperty enableDithering;
		SerializedProperty blueNoiseTexture;
		...
		//	_target = (LSky)target;
			...
			starsCube      = serObj.FindProperty("starsCube");
			...
			nightColorType 	    = serObj.FindProperty("m_NightColorType");
			moonInfluence 	    = serObj.FindProperty("m_MoonInfluence");
			...
			enableSunDisc = serObj.FindProperty("m_EnableSunDisc");
			sunDiscSize   = serObj.FindProperty("sunDiscSize");
			sunDiscColor  = serObj.FindProperty("sunDiscColor");

			enableMoon      = serObj.FindProperty("m_EnableMoon");
			...
			outerSpaceOffset         = serObj.FindProperty("m_OuterSpaceOffset");
			enableStars 			 = serObj.FindProperty("m_EnableStars");
			...
			enableNebula 	= serObj.FindProperty("m_EnableNebula");
			nebulaColor     = serObj.FindProperty("nebulaColor");
			nebulaIntensity = serObj.FindProperty("nebulaIntensity");
			//----------------------------------------------------------------

			HDR         = serObj.FindProperty("m_HDR");
			enableDithering = serObj.FindProperty ("m_EnableDithering");
			blueNoiseTexture = serObj.FindProperty ("blueNoiseTexture");
			...
			sunLightThreshold   = serObj.FindProperty("m_SunLightThreshold");
			//----------------------------------------------------------------
			...
			ambientMode	        = serObj.FindProperty("m_AmbientMode");
			...
			enableUnityFog	       = serObj.FindProperty("m_EnableUnityFog");
			unityFogMode	       = serObj.FindProperty("m_UnityFogMode");
