...
//---------------------------------------
// Utility methods for custom inspectors.
//=======================================
...
namespace AC.EditorGUIUtility
{
	...
	public static class AC_EditorGUIUtility
	{
		...
		public static void ShurikenFoldoutHeader(string text, GUIStyle texStyle, Color col, ref bool foldout)
		{
